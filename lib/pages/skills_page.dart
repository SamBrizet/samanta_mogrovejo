        ...
        child: Column(
          ...
          children: [
            _buildSkillSection(
              ...
              Color(0xFF4ECDC4),
              [
                {'name': 'Flutter', 'level': 0.9, 'color': Color(0xFF02569B)},
                {'name': 'Dart', 'level': 0.9, 'color': Color(0xFF0175C2)},
                {'name': 'Firebase', 'level': 0.8, 'color': Color(0xFFFFCA28)},
                {'name': 'Git', 'level': 0.8, 'color': Color(0xFFF05032)},
                {'name': 'REST APIs', 'level': 0.85, 'color': Color(0xFF61DAFB)},
                {'name': 'Provider / Bloc', 'level': 0.8, 'color': Color(0xFF9C27B0)},
